...
class FaceSwap:
    ...
    def GetDelaunayTriangulation(self, DelaunayBBox, LandMarkPoints, InputImage):
        ...
        if(debug):
            ...
            for triangle in DelaunayTriangleList:
                ...
                cv2.line(InputImage, a, b, (0, 0, 255), 2, cv2.LINE_AA, 0)
                cv2.line(InputImage, b, c, (0, 0, 255), 2, cv2.LINE_AA, 0)
                cv2.line(InputImage, c, a, (0, 0, 255), 2, cv2.LINE_AA, 0)

            op = cv2.resize(InputImage, (720, 720))
            self.HelperFunctions.ShowImage(op, 'Facial Landmarks')
    ...
    def FaceWarpByTriangulation(self, weight):
        TargetImg = self.Images[1]
        SrcImg = self.Images[0]
...
def main():
    ...
    Parser.add_argument('--Image_Path_1', default='/home/rohith/CMSC733/git/FaceSwap/Data/hillary.jpeg',
                        help='Image path of target image, Default:/home/rohith/CMSC733/git/FaceSwap/Data/hillary.jpeg')
    Parser.add_argument('--Image_Path_2', default='/home/rohith/CMSC733/git/FaceSwap/Data/trump.jpeg',
